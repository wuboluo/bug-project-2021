...
namespace Bug.Project21.Skills
{
    public class SkillSO : ScriptableObject
    {
        ...
        [BoxGroup("Basic/通用")] [VerticalGroup("Basic/通用/Right")] [LabelText("技能类型")] [SerializeField]
        private PropSkillType type;

        [BoxGroup("Basic/通用")] [VerticalGroup("Basic/通用/Right")] [LabelText("技能图标")] [SerializeField] [PreviewField(40)]
        private Texture2D icon;

        [BoxGroup("Basic/描述")] [HideLabel] [SerializeField] [TextArea(3, 10)]
        private string skillDescribe;

        [BoxGroup("Basic/属性")] [LabelText("作用于")] [SerializeField]
        private SkillAttrActingOn target;

        [BoxGroup("Basic/属性")] [LabelText("AOE")] [SerializeField]
        private bool isAOE;

        [BoxGroup("Basic/属性")] [LabelText("基础伤害")] [SerializeField]
        private float value;
        ...
        [BoxGroup("Basic/音特效")] [LabelText("音效")] [SerializeField]
