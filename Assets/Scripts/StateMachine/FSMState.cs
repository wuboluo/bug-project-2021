...
public abstract class FSMState
{
    ...
    public void AddTransition(Transition trans, StateID id)
    {
        ...
        {
            Debug.LogError("FSMState ERROR: State " + stateID + " already has transition " + trans +
    ...
    public void DeleteTransition(Transition trans)
    {
        ...
        Debug.LogError("FSMState ERROR: Transition " + trans + " passed to " + stateID +
    ...
    public StateID GetOutputState(Transition trans)
    {
        ...
        if (map.ContainsKey(trans)) return map[trans];
